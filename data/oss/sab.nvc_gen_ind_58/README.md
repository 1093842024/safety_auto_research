# sab.nvc_gen_ind_58  (SAB instance #58)
...
corpus and are symlinked at launch time by the sandbox runner:
    ...
    benchmark_tasks/suites/data/vendor/ScienceAgentBench/benchmark/gold_programs/nvc_gen_ind.py   (reference solve program)
    benchmark_tasks/suites/data/vendor/ScienceAgentBench/benchmark/eval_programs/eval_syllogistic_nvc_gen_ind.py   (grader)

L1 launch:

    python /repo/scripts/sandbox_examples/run_sab_sandbox.py --data-dir /data/ --task sab.nvc_gen_ind_58
