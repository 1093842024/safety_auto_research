# sab.dili_models_ecfp_rf_18  (SAB instance #18)
...
corpus and are symlinked at launch time by the sandbox runner:
    ...
    benchmark_tasks/suites/data/vendor/ScienceAgentBench/benchmark/gold_programs/DILI_models_ECFP_RF.py   (reference solve program)
    benchmark_tasks/suites/data/vendor/ScienceAgentBench/benchmark/eval_programs/eval_DILI_RF.py   (grader)

L1 launch:

    python /repo/scripts/sandbox_examples/run_sab_sandbox.py --data-dir /data/ --task sab.dili_models_ecfp_rf_18
