...
corpus and are symlinked at launch time by the sandbox runner:
    ...
    benchmark_tasks/suites/data/vendor/ScienceAgentBench/benchmark/gold_programs/saliva.py   (reference solve program)
    benchmark_tasks/suites/data/vendor/ScienceAgentBench/benchmark/eval_programs/biopsykit_saliva_eval.py   (grader)

L1 launch:

    python /repo/scripts/sandbox_examples/run_sab_sandbox.py --data-dir /data/ --task sab.saliva_85
