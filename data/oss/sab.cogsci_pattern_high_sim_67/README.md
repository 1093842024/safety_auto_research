# sab.cogsci_pattern_high_sim_67  (SAB instance #67)
...
corpus and are symlinked at launch time by the sandbox runner:
    ...
    benchmark_tasks/suites/data/vendor/ScienceAgentBench/benchmark/gold_programs/CogSci_pattern_high_sim.py   (reference solve program)
    benchmark_tasks/suites/data/vendor/ScienceAgentBench/benchmark/eval_programs/CogSci_pattern_high_sim_eval.py   (grader)

L1 launch:

    python /repo/scripts/sandbox_examples/run_sab_sandbox.py --data-dir /data/ --task sab.cogsci_pattern_high_sim_67
